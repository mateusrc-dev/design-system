...
declare const TooltipContainer: _stitches_react_types_styled_component.StyledComponent<"span", {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        gray100: string;
...
declare const ButtonSvgContainer: _stitches_react_types_styled_component.StyledComponent<"button", {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        gray100: string;
...
interface buttonSvgProps extends ComponentProps<typeof ButtonSvgContainer> {
    children?: ReactNode;
}
declare function ButtonSvg({ children, ...props }: buttonSvgProps): JSX.Element;
declare namespace ButtonSvg {
    var displayName: string;
}
...
declare const theme: string & {
    ...
    colors: {
        ...
        testTwo: _stitches_react_types_theme.Token<"testTwo", string, "colors", "">;
    };
    fontSizes: {
...
declare const createTheme: <Argument0 extends string | ({
    colors?: {
        ...
        testTwo?: string | number | boolean | undefined;
    } | undefined;
    fontSizes?: {
...
export { Avatar, AvatarProps, Box, BoxProps, Button, ButtonProps, ButtonSvg, Checkbox, CheckboxProps, Heading, HeadingProps, MultiStep, MultiStepProps, Text, TextArea, TextAreaProps, TextInput, TextInputProps, TextProps, Toast, ToastProps, Tooltip, TooltipProps, buttonSvgProps, config, createTheme, css, getCssText, globalCss, keyframes, styled, theme };
